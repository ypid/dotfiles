    ...
    " General Programming {{{
        if count(g:spf13_bundle_groups, 'programming')
            ...
            " Ack {{{
                ...
                " Your call to exists() doesn't work because plugins are only
                " loaded after vim has finished processing your .vimrc.
                " if exists(":Ack") && !exists(":Ag")
                "
                " Did not work, error when :Ag is called: E488: Trailing characters
